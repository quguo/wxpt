      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs">
            <a href="/wxpt/index.php/Admin/Category/add" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增分类</a>
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-check"><input type="checkbox" /></th><th class="table-id">#</th><th class="table-title">分类名称</th><th class="table-type">状态</th><th class="table-type">操作</th>
              </tr>
          </thead>
          <tbody>

         
			<?php if(is_array($cateTree)): foreach($cateTree as $key=>$vo): ?><tr id="<?php echo ($vo["id"]); ?>">
	              ...
	              <td >
	                <div class="am-btn-toolbar">
	                  <div class="am-btn-group am-btn-group-xs">
	                    <a href="/wxpt/index.php/Admin/Category/edit/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
...
<script type="text/javascript">
    ...
    $(".am-modal-bd").html("是否要删除?"+val)
      $('#my-confirm').modal({
            ...
            onConfirm: function(options) {
              $.post("/wxpt/index.php/Admin/Category/del",{id:val},function(data){
                if(data.status == 0){
  ...
  $(function(){
     $("#callback").on('closed.modal.amui',function(){
        window.location='/wxpt/index.php/Admin/Category/index'
      })
  })
</script>
</html>