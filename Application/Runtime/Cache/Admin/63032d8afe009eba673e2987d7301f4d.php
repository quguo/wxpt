          ...
          <div class="am-u-sm-8 am-u-md-10">
            <form action="" class="am-form am-form-inline">
              <div class="am-form-group">
                ...
                <input type="text" class="am-form-field am-input-sm" placeholder="" name="title" value="<?php echo ($info["title"]); ?>">
              </div>
            </form>
          </div>
        </div>
        <?php if(is_array($arr)): foreach($arr as $key=>$vo): ?><div class="am-g am-margin-top" >
            <div class="am-u-sm-4 am-u-md-2 am-text-right"><?php echo ($vo["name"]); ?>权限</div>
            <div class="am-u-sm-8 am-u-md-10" style="margin-bottom:10px;">
              <div class="am-btn-group" data-am-button>
                <?php if(is_array($vo[child])): foreach($vo[child] as $key=>$v): ?><label class="btnlist am-btn am-btn-primary am-btn-xs <?php echo inArray($v['id'],$rules,"am-active");?> " style="margin-bottom:5px;margin-right:5px; ">
                    <input type="checkbox" name="list[]" value="<?php echo ($v["id"]); ?>" <?php echo inArray($v['id'],$rules,"checked='true' ");?>> <?php echo ($v["title"]); ?> 
...
<script type="text/javascript">
  $(function(){
    ...
    $("#add").click(function(){
        ...
        $.post("/wxpt/index.php/Admin/Rbac/groupEdit",val,function(data){
          if (data.status == 0) {
     ...
     $("#callback").on('closed.modal.amui',function(){
        window.location='/wxpt/index.php/Admin/Rbac/listGroup'
      })
