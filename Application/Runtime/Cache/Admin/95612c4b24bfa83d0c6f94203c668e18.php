          ...
          <fieldset>
            <div class="am-form-group">
              ...
              <select id="doc-select-1" required name="pid" >
                ...
                <option value="0" <?php if($info[pid] == 0): ?>selected<?php endif; ?>>顶级栏目</option>
                <?php if(is_array($catelist)): foreach($catelist as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo[id] == $info[pid]): ?>selected<?php endif; ?>><?php echo ($vo["cname"]); ?></option><?php endforeach; endif; ?>
              </select>
            </div>
    ...
    $('#form').validator({
      submit:  function(e) {
          ...
          $.ajax({
            ...
            url:"<?php echo U("Admin/Category/save");?>",
