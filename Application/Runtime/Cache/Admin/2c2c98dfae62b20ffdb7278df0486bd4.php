      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs">
            <a href="/wxpt/index.php/Admin/System/addUser" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</a>
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          ...
          <tbody>
			...
			<?php if(is_array($data)): foreach($data as $key=>$vo): if($vo[id] != 1): ?><tr>
	              <td><input type="checkbox" value="<?php echo ($vo["id"]); ?>" /></td>
	              <td><?php echo ($key); ?></td>
	              <td><?php echo ($vo["name"]); ?></td>
	              <td><?php echo ($vo['group']['title']); ?></td>
	              <td><?php if($vo['status'] == 1): ?>开启<?php else: ?>禁用<?php endif; ?></td>
	              <td>
	                <div class="am-btn-toolbar">
	                  <div class="am-btn-group am-btn-group-xs">
	                    <a href="<?php echo U("System/editUser",array("id"=>$vo['id']));?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
	                    
	                    <a href="javascript:;" data-id="<?php echo ($vo["id"]); ?>"  class="del am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only "><span class="am-icon-trash-o"></span> 删除</a>
	                  </div>
	                </div>
	              </td>
  ...
  $(function(){
     $('.del').on('click', function(e) {
        ...
        onConfirm: function(options) {
          ...
          var id = $link.data('id');
          $.post("/wxpt/index.php/Admin/System/delUser",{id:id},function(data){
            if(data.status == 0){
   ...
   /* $(".del").click(function(){
     ...
     $("#callback").on('closed.modal.amui',function(){
        ...
        if(status != 0){
          window.location='/wxpt/index.php/Admin/System/index'
        }
      })
  })
</script>
