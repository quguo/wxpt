      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs">
            <a href="/wxpt/index.php/Admin/Article/add" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增文章</a>
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          ...
          <tbody>
			...
			<?php if(is_array($datalist)): foreach($datalist as $key=>$vo): ?><tr id="<?php echo ($vo["id"]); ?>">
                ...
                <td><?php echo ($vo["createtime"]); ?></td>
	              ...
	              <td >
	                <div class="am-btn-toolbar">
	                  <div class="am-btn-group am-btn-group-xs">
	                    <a href="/wxpt/index.php/Admin/Article/edit/aid/<?php echo ($vo["aid"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
	                    <a href="javascript:;" onclick="rulesDel(<?php echo ($vo["aid"]); ?>)" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only my-confirm"><span class="am-icon-trash-o"></span> 删除</a>
	                  </div>
	                </div>
	              </td>
...
<script type="text/javascript">
    ...
    $(".am-modal-bd").html("是否要删除?"+val)
      $('#my-confirm').modal({
            ...
            onConfirm: function(options) {
              $.post("/wxpt/index.php/Admin/Article/del",{aid:val},function(data){
                if(data.status == 0){
  ...
  $(function(){
     $("#callback").on('closed.modal.amui',function(){
        window.location='/wxpt/index.php/Admin/Article/index'
      })
  })
</script>
</html>