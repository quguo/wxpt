      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs">
            <a href="/wxpt/index.php/Admin/Rbac/addGroup" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 添加用户组</a>
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-check"><input type="checkbox" /></th><th class="table-id">#</th><th class="table-title">用户组名称</th><!--<th class="table-type">拥有权限</th>--><th class="table-type">操作</th>
              </tr>
          </thead>
          <tbody>

         
			<?php if(is_array($group)): foreach($group as $key=>$vo): ?><tr id="<?php echo ($vo["id"]); ?>">
	              ...
	              <td >
	                <div class="am-btn-toolbar">
	                  <div class="am-btn-group am-btn-group-xs">
	                    <a href="/wxpt/index.php/Admin/Rbac/groupEdit/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑/查看权限</a>
	                    <!--<a href="javascript:;" title="<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only my-confirm"><span class="am-icon-trash-o"></span> 删除</a>-->
	                  </div>
	                </div>
	              </td>
